...
public class Vehicles implements Serializable {
    ...
    private Collection<Parkings> parkingsCollection;
    ...
    @XmlTransient
    public Collection<Parkings> getParkingsCollection() {
        return parkingsCollection;
    }

    public void setParkingsCollection(Collection<Parkings> parkingsCollection) {
